 ...
 */
export class TbmChecklistGtcMfdHomePage extends GtcView<GtcMfdHomePageProps> {
  ...
  public constructor(props: GtcMfdHomePageProps) {
    ...
    if (this.props.displayPaneIndex === undefined) {
      throw new Error('TbmChecklistGtcMfdHomePage: display pane index was not defined');
    }
