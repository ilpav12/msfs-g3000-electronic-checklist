...
export class TbmAmplifiedChecklists {
  ...
  public static getChecklists(): TbmChecklist[] {
    return [
      new TbmChecklist(
        TbmAmplifiedChecklistNames.PreflightInspection,
        ...
        [
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "It is divided in 6 subparts to cover all items of the preflight",
            imagePath:
              ChecklistFilePaths.ASSETS_PATH +
              "/preflight-inspection-locations.png",
          },
          {
            type: ChecklistItemType.PlainText,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "Open door of emergency landing compartment to check LANDING GEAR emergency control.",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "15. Lever",
          ...
          },
          {
            type: ChecklistItemType.Note,
            content:
              "NOTE: By-pass selector must be pushed at its maximum stop, so as to have the door in place.",
          },
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.Caution,
            content:
              "CAUTION: Before selecting source, check position of ignition and starter switches.",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "36. IGNITION\nswitch",
          ...
          { type: ChecklistItemType.PlainText, content: "DE ICE SYSTEM panel" },
          {
            type: ChecklistItemType.Warning,
            content:
              "WARNING: Do not touch pitots nor stall warning vane. They could be hot enough to burn skin.",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "55. PITOT L\nHTR switch",
          ...
          { type: ChecklistItemType.PlainText, content: "Outside inspection" },
          {
            type: ChecklistItemType.PlainText,
            content:
              "The preflight inspection described in the opening figure is recommended before each flight.",
          },
          {
            type: ChecklistItemType.Note,
            content:
          ...
          },
          {
            type: ChecklistItemType.Warning,
            content:
              "WARNING: If the clogging indicator is extended, red collar visible, the flight is not authorized.",
          },
          {
            type: ChecklistItemType.Challenge,
            content:
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.InsideInspection,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.PlainText,
          ...
          },
          {
            type: ChecklistItemType.Note,
            content:
              "NOTE: If not, starter is going to operate as soon as SOURCE selector is positioned on BATT or GPU.",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "22. IGNITION\nswitch",
          ...
          },
          {
            type: ChecklistItemType.Caution,
            content:
              "CAUTION: Make sure that MAN OVRD control is backward to avoid overtemperature risks at start.",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "38. MAN OVRD\ncontrol",
          ...
          },
          {
            type: ChecklistItemType.Caution,
            content:
              "CAUTION: When the engine is shut down, the THROTTLE must not be moved into the reverse area.",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "39. THROTTLE",
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.BeforeStartingEngine,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.PlainText,
          ...
          },
          {
            type: ChecklistItemType.Note,
            content:
              "NOTE: Voltage is higher than 24.5 Volts which corresponds to the voltage in case of battery use.",
          },
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.EngineStart,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "- lights on (max ITT < 870°C for more than 20 seconds, < 1000°C for more than 5 seconds),",
            justification: Justification.Indent2,
          },
          {
            type: ChecklistItemType.PlainText,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.Motoring,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.PlainText,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.MotoringFollowedByEngineStart,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.PlainText,
          ...
          },
          {
            type: ChecklistItemType.Note,
            content:
              "NOTE: MAIN GEN normally goes off as soon as STARTER goes off.",
          },
          {
            type: ChecklistItemType.PlainText,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.AfterEngineStartWithGPU,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.AfterEngineStart,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Caution,
          ...
          },
          {
            type: ChecklistItemType.Note,
            content:
              "NOTE: Cabin temperature will not be properly regulated when the A/C switch is set to OFF.",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "22. TEMP\nselector",
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.InFlightAvailableOxygenQuantity,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.BeforeTaxiing,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.Challenge,
            content:
              "3. Check illumination of the green\nlight located above the switch.",
            response: null,
            justification: Justification.Indent1,
          },
          {
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "Landing Field Elevation selection is done on the touchscreen controller using either:",
            justification: Justification.Indent1,
          },
          {
            type: ChecklistItemType.PlainText,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "- a manual entry by pressing: HOME, AIRCRAFT SYSTEMS, LFE and then MANUAL.",
            justification: Justification.Indent1,
          },
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.Taxiing,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Caution,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.BeforeLineUp,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Caution,
          ...
          },
          {
            type: ChecklistItemType.Caution,
            content:
              "CAUTION: Do not take off if battery charge > 50 amps ± 4 amps.",
          },
          {
            type: ChecklistItemType.Note,
            content:
          ...
          },
          {
            ...
            response: "Check",
            imagePath:
              ChecklistFilePaths.ASSETS_PATH + "/rotation-airspeed.png",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "42. Pilot's /\nPassengers'belts",
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.NormalTakeoff,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.PlainText,
          ...
          },
          {
            type: ChecklistItemType.Caution,
            content:
              "CAUTION: If heavy precipitation, turn IGNITION and INERT SEP switches to ON.",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "1. ADI / HSI /\nheadings",
          ...
          },
          {
            type: ChecklistItemType.Warning,
            content:
              "WARNING: It is recommended not to retract FLAPS to UP before 500 ft AGL.",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "16. Airspeed",
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.ShortTakeoff,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.PlainText,
          ...
          },
          {
            type: ChecklistItemType.Note,
            content:
              "NOTE: On short runway, maximum torque will be applied before brakes release.",
          },
          {
            type: ChecklistItemType.PlainText,
            content: "11 - Rotation airspeed",
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.AfterTakeoff,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.Climb,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.Cruise,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.BeforeDescent,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.Approach,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.Caution,
            content:
              "CAUTION: If heavy precipitation, turn IGNITION and INERT SEP switch to ON.",
          },
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.FinalOrDownwind,
        TbmChecklistCategory.Amplified,
        [
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.ShortFinal,
        TbmChecklistCategory.Amplified,
        [
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.Landing,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Warning,
          ...
          { type: ChecklistItemType.PlainText, content: "After wheels touch:" },
          {
            type: ChecklistItemType.Caution,
            content:
              "CAUTION: On snowy or dirty runway, it is better not to use reverse below 40 KIAS.",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "2. Reverse",
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.GoAroundAPOff,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.GoAroundAPOn,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.TouchAndGo,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.PlainText,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.RunwayClear,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.PlainText,
      ...
      new TbmChecklist(
        TbmAmplifiedChecklistNames.Shutdown,
        TbmChecklistCategory.Amplified,
        [
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.Note,
            content:
              "NOTE: Keep THROTTLE on LO-IDLE position for 15 sec minimum before shutting down engine.",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "14. THROTTLE",
          ...
          },
          {
            type: ChecklistItemType.Note,
            content:
              "NOTE: The MD302 can be manually shut down when in the discharge mode to conserve battery power.",
          },
          {
            type: ChecklistItemType.Challenge,
            content:
      ...
      new TbmChecklist(
        ...
        [
          ...
          },
          {
            type: ChecklistItemType.Challenge,
            content:
              "2. Install air inlet and\nstatic port plugs, and\nexhaust and pitot covers.",
            response: null,
          },
          {
            type: ChecklistItemType.Note,
            content:
              "NOTE: Be careful of exhaust stubs temperature before installing covers.",
          },
          {
            type: ChecklistItemType.Note,
            content:
              "NOTE: 15 to 20 minutes after the engine shutdown, check engine oil level.",
          },
        ],
        true,
      ),
