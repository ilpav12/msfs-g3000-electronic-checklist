  ...
  public static getChecklists(): LongitudeChecklist[] {
    return [
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.CockpitCabinInspection,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.CockpitPreparation,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "(Refer to Normal Procedures, Expanded Preflight Procedures.)",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "8. Trims (3)",
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.BeforeStart,
        LongitudeChecklistCategory.Normal,
        [
          {
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.StartingEnginesUsingAPU,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.PlainText,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.BeforeTaxi,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.Challenge,
            content:
              "d. Verify selected side hydraulic\npressure cycles anywhere within:",
            response: null,
            justification: Justification.Indent1,
          },
          {
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.Taxi,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.BeforeTakeoff,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.Takeoff,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Caution,
          ...
          },
          {
            type: ChecklistItemType.Note,
            content:
              "Autothrottle is inhibited during takeoff and up to 400 feet AGL.",
          },
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.AfterTakeoffClimb,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.Cruise,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.Note,
            content:
              "AT (if used) will decrease to CRU 10 minutes after level off.",
          },
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.Descent,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.Approach,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.BeforeLanding,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.Landing,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.GoAround,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.AfterLanding,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.Shutdown,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "a. Engine inlet and exhaust covers should be installed to prevent FOD ingestion.",
            justification: Justification.Indent2,
          },
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "(Refer to Volume 2, Normal Procedures, Refuel/Defuel Panel.)",
          },
          {
            type: ChecklistItemType.Note,
            content: "NOTE",
          ...
          },
          {
            type: ChecklistItemType.Note,
            content:
              "Oil levels are most accurate between 5 and 30 minutes after engine shutdown.",
          },
          {
            type: ChecklistItemType.Challenge,
            content:
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.QuickTurn,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "a. Verify all displays remain powered and BUS TIE Button indicates OPEN.",
            justification: Justification.Indent2,
          },
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.StartingAPU,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.PlainText,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "a. Red APU FIRE button illuminates momentarily, then extinguishes.",
            justification: Justification.Indent3,
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "b. Green digits for APU RPM% and EGT deg C are displayed within 10 seconds of selecting ON.",
            justification: Justification.Indent3,
          },
          {
            type: ChecklistItemType.Note,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.EngineDryMotor,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.PlainText,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.TurbulentAirPenetration,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Note,
          ...
          },
          {
            type: ChecklistItemType.Challenge,
            content:
              "2. Maintain a constant attitude without\nchasing altitude.\nAvoid sudden large control movements.",
            response: null,
          },
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.CockpitControls,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.Trims,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "(1) Amber STAB TRIM FAIL A-B and white AP FAIL CAS messages display.",
            justification: Justification.Indent3,
          },
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "(1) Amber STAB TRIM FAIL A-B and white AP FAIL CAS messages clear.",
            justification: Justification.Indent3,
          },
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.Initialization,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "(d) Right stick shaker activates independently and stops.",
            justification: Justification.Indent4,
          },
          {
            type: ChecklistItemType.PlainText,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "(a) Steady MASTER CAUTION and flashing MASTER WARNING lights.",
            justification: Justification.Indent4,
          },
          {
            type: ChecklistItemType.PlainText,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "(b) Steady MASTER CAUTION and flashing MASTER WARNING lights.",
            justification: Justification.Indent4,
          },
          {
            type: ChecklistItemType.PlainText,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "(c) Test is complete when a green PASS is indicated on the selected button.",
            justification: Justification.Indent4,
          },
          {
            type: ChecklistItemType.Challenge,
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "(a) Test is complete when a green PASS is indicated on the selected button.",
            justification: Justification.Indent4,
          },
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        LongitudeNormalChecklistNames.IceProtectionSystems,
        LongitudeChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new LongitudeChecklist(
        ...
        [
          ...
          { type: ChecklistItemType.Subtitle, content: "Takeoff" },
          {
            type: ChecklistItemType.PlainText,
            content:
              "Conduct a normal static takeoff and climb with the following exceptions:",
          },
          {
            type: ChecklistItemType.Challenge,
            content: "1. Flaps",
