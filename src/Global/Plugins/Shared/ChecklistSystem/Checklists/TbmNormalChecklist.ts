...
export class TbmNormalChecklists {
  ...
  public static getChecklists(): TbmChecklist[] {
    return [
      ...
      new TbmChecklist(
        TbmNormalChecklistNames.EngineStart,
        TbmChecklistCategory.Normal,
        [
          {
          ...
          },
          {
            ...
            response: "Monitor",
            imagePath:
              ChecklistFilePaths.ASSETS_PATH + "/max-engine-values.png",
            justification: Justification.Indent1,
          },
      ...
      new TbmChecklist(
        TbmNormalChecklistNames.AfterEngineStartWithGPU,
        TbmChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmNormalChecklistNames.AfterEngineStart,
        TbmChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmNormalChecklistNames.BeforeLineUp,
        TbmChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmNormalChecklistNames.ShortTakeoff,
        TbmChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmNormalChecklistNames.AfterTakeoff,
        TbmChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmNormalChecklistNames.BeforeDescent,
        TbmChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmNormalChecklistNames.Approach,
        TbmChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmNormalChecklistNames.FinalOrDownwind,
        TbmChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmNormalChecklistNames.ShortFinal,
        TbmChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        TbmNormalChecklistNames.RunwayClear,
        TbmChecklistCategory.Normal,
        [
          {
            type: ChecklistItemType.Challenge,
      ...
      new TbmChecklist(
        ...
        [
          ...
          },
          {
            type: ChecklistItemType.PlainText,
            content:
              "21. Install air inlet and static port plugs, and exhaust and pitot covers.",
          },
          {
